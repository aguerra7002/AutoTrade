 ...
 * from another project. However, I included it because this could be VERY useful code in the future when dealing 
 * with more data, and even is detailed in the below reference paper and the paper linked to in the pdf. 
 */
