 ...
 * type of learning. This is iteration 1 and is very similar to the example code from dl4j's website
 */
 ...
 */
public class BasicLSTMIter1 {

	// define a sentence to learn.
    // Add a special character at the beginning so the RNN learns the complete string and ends with the marker.
	private static final int[] LEARNSTRING = new int[] {0,1,2,3,4,5,4,3,2,1,2,3,4,5,4,3,2,1,2,3};

	// a list of all possible characters
	private static final List<Integer> LEARNSTRING_CHARS_LIST = new ArrayList<>();
